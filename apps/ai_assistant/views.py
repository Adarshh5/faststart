...
from apps.user_data.models import (
    SavedGrammar, UserVocabulary, SavedVocabulary,UserDailyStoryUsage,
    UserDailyMessageUsage, UserFreeTierStart, UserDailyDoubtSolving)
...
def includevocabulary(user):
    ...
    user_vocab_list = [word.word_name for word in user_vocab_qs if word]
